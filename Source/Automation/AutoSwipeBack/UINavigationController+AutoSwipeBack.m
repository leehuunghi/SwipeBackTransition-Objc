...
{
    objc_setAssociatedObject(self, (__bridge const void * _Nonnull)(__AssocKey.swipeBack), swipeBack, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}

- (nullable SwipeBackController*)swipeBack
{
    return objc_getAssociatedObject(self, (__bridge const void * _Nonnull)(__AssocKey.swipeBack));
}
@end
