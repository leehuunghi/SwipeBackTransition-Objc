...
{
    objc_setAssociatedObject(self, CFBridgingRetain((__AssocKey.swipeToDismiss)), swipeToDismiss, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}

- (SwipeToDismissController *)swipeToDismiss {
    return objc_getAssociatedObject(self, CFBridgingRetain((__AssocKey.swipeToDismiss)));
}
